...
export default class LocalStudentAppForm extends React.Component {
    ...
    render (){
        return (
            <View>
                ...
                <Text>What aspect(s) do you most want to help with?</Text>
                <FlatList
                ...
                this.props.navigation.navigate('LocalProfile')}></Button>
            </View>
        );
    }
}
